...
external_url 'https://gitlab.projectdevops.com'
...
'main' => {
  ...
  'bind_dn' => 'cn=admin,dc=ldap,dc=adop,dc=com',
  'password' => 'de7bf6422c764996',
  'active_directory' => false,
  'base' => 'dc=ldap,dc=adop,dc=com',
#  'group_base' => 'O',
...
gitlab_rails['smtp_user_name'] = "AKIAUQ4IVY6PDA4QTKWQ"
gitlab_rails['smtp_password'] = "BNeQ2v0mOe1cbgiSnrpMbEpHc4FtUcHaM+fQKLTU5k55"
gitlab_rails['smtp_enable_starttls_auto'] = true
gitlab_rails['smtp_openssl_verify_mode'] = 'peer'
gitlab_rails['smtp_domain'] = "awsamazon.com"
gitlab_rails['smtp_authentication'] = "login"
gitlab_rails['gitlab_email_from'] = 'jenkins@neem.awsapps.com'
